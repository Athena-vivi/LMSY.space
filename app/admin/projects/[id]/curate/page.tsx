...
function SortableImage({ image, index }: { image: GalleryImage; index: number }) {
  const {
    attributes,
    listeners,
    setNodeRef,
...
export default function CurateProjectPage({ params }: { params: { id: string } }) {
  ...
  const fetchProjectAndImages = async () => {
    ...
    if (galleryData) {
      ...
      const sortedImages = galleryData.sort((a: GalleryImage, b: GalleryImage) => {
    ...
    <div className="min-h-screen bg-black">
      ...
      <main className="p-6 max-w-[1920px] mx-auto">
        ...
        >
          ...
          >
            {/* Responsive Masonry - Scale 0.8 for density */}
            <div
