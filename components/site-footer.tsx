        ...
        <div className="py-16 md:py-24">
          ...
          <div className="text-center space-y-2">
            <p className="text-xs text-muted-foreground/60">
              © 2026 lmsy.space | <span className="bg-gradient-to-r from-lmsy-yellow to-lmsy-blue bg-clip-text text-transparent font-medium">Curated by Aster</span>. Made with love for LMSY & Besties.
            </p>
          </div>
        </div>
      </div>
